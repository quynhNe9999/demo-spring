...
<div class="contact py-sm-5 py-4">
    <div class="container py-xl-4 py-lg-2">
        <!-- form -->
        <form id="form" action="${pageContext.request.contextPath}/yourServletMapping" method="post" enctype="multipart/form-data">
            <div class="contact-grids1 w3agile-6">
                ...
                <a href="${pageContext.request.contextPath}/image/show" style="float:left;" class="btn btn-success text-right">Show All</a>
            </div>
            <br>
